...
# hormone condition
message("Building hormone GRN...")
res.h <- infer_lagged_grn_single_condition(expr=pb_mat,
                                           meta=pb_meta,
                                           ...
                                           n_perm=100,
                                           threads=36)
saveRDS(res.h, file="dGRN_glmnet_ridge.hormone.resuts.rds")

# non-hormone condition
message("Building non-hormone GRN...")
res.h <- infer_lagged_grn_single_condition(expr=pb_mat,
                                           meta=pb_meta,
                                           regulators=regulators,
                                           condition_value=F,
                                           ...
                                           n_perm=100,
                                           threads=36)
saveRDS(res.h, file="dGRN_glmnet_ridge.non_hormone.resuts.rds")
